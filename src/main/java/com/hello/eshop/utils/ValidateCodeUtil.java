...
public class ValidateCodeUtil {
    ...
    //private static String randString = "abcdefghijklmnopqrstuwxyz";//随机产生只有字母的字符串
    private static String randString = "0123456789abcdefghijklmnopqrstuwxyz";//随机产生数字与字母组合的字符串
    ...
    private static String drowString(Graphics g, String randomString, int i) { 
        ...
        String rand = String.valueOf(getRandomString(random.nextInt(randString 
                .length()))); 
        randomString += rand; 
        g.translate(random.nextInt(6), random.nextInt(6));// 偏移度
